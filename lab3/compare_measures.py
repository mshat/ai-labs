from tree.tree_tools import get_leafs, calc_max_distance_between_nodes, calc_distance_between_all_nodes
...
def compare_measures(tree, artist_pairs):
    ...
    max_distance_between_artists = calc_max_distance_between_nodes(distances_between_nodes)
