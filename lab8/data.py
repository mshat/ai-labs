...
keywords = {
    ...
    'filter': {
        'include': ('оставить', 'оставлять', 'выводить', 'вывести', 'показывать', 'показать', 'найти'),
        'exclude': ('убрать', 'исключать', 'исключить', 'отмести', 'отметать', 'выкинуть', 'выкидывать', 'отсеить', 'отсеивать', 'удалять', 'удалить'),
        'all': ('весь', 'всё'),
        'year': ('год',),
        'older': ('старший', 'большой', 'за'),
    ...
    'like': {
        'include': ('добавить', 'включить', 'прибавить'),
        'exclude': ('убрать', 'исключить', 'выкинуть', 'удалить', 'удаль', 'удали'),
        'like': ('нравиться', 'лайк', 'любить'),
        'favorite': ('любимый', 'лайковый',)
    },
    'dislike': {
        'dislike': ('не нравиться', 'дизлайк', 'не любить'),
        'unloved': ('нелюбимый', 'дизлайковый', )
    },
    'number': {
        'how many': ('сколько',),
        'number': ('количество',),
